...
echo    "====>Generating the channel create tx for medlinechannel"
configtxgen -outputCreateChannelTx  medlinechannel.tx -channelID medlinechannel  -profile MedlineChannel

echo    "====>Generating the channel create tx for presverchannel"
configtxgen -outputCreateChannelTx  prescverchannel.tx -channelID prescverchannel  -profile PrescVerChannel

echo    "====>Generating the channel create tx for pharmafulchannel"
configtxgen -outputCreateChannelTx  pharmafulchannel.tx -channelID pharmafulchannel  -profile PharmaFulChannel

echo    "====>Generating the channel create tx for deliverychannel"
configtxgen -outputCreateChannelTx  deliverychannel.tx -channelID deliverychannel  -profile DeliveryChannel
...
./bins/run-all-v1.sh $1 medlinechannel
./bins/run-all-v1.sh $1 prescverchannel
./bins/run-all-v1.sh $1 pharmafulchannel
./bins/run-all-v1.sh $1 deliverychannel
